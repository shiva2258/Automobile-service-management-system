...
class PDF extends FPDF {
    function Header(){
        ...
        $this->Cell(40,10,'Automobile ID',1,0,'C',true);
        $this->Cell(40,10,'Bill No.',1,0,'C',true);
        $this->Cell(70,10,'Delivery Address',1,0,'C',true);
        $this->Cell(40,10,'Delivery By',1,0,'C',true);
        $this->Cell(40,10,'Delivery date',1,1,'C',true);
...
$query=mysqli_query($con,"select * from delivery");
while($data=mysqli_fetch_array($query)){
        $pdf->Cell(40,10,$data['0'],1,0,'R');
        $pdf->Cell(40,10,$data['1'],1,0,'R');
        $pdf->Cell(40,10,$data['2'],1,0,'R');
        $pdf->Cell(70,10,$data['3'],1,0);
        $pdf->Cell(40,10,$data['4'],1,0);
        $pdf->Cell(40,10,$data['5'],1,1);
}
