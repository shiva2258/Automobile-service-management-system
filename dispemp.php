...
<head>
    ...
    <title>Automobile Services - Display Employees</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $var = mysqli_query($con, "select emp_id, emp_name, emp_age, emp_gender, emp_salary from employee");
            echo "<table border size=20 solid blue>";
            echo "<tr><th>Employee ID</th><th>Employee Name</th><th>Employee Age</th><th>Employee Gender</th><th>Employee Salary</th></tr>";

            if(mysqli_num_rows($var)>0){
                echo "No. of Employees: " . mysqli_num_rows($var);
                while($arr=mysqli_fetch_row($var)){
                    echo "<tr><td>$arr[0]</td><td>$arr[1]</td><td>$arr[2]</td><td>$arr[3]</td><td>$arr[4]</tr></tr>";
                }
                echo "</table>";
        ...
        <button onclick="window.location.href='genemppdf.php';">Download Employee List</button>
        </div>
    </div> 
</body>
</html>