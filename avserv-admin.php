...
<body>
    ...
    <div class="container">
        ...
        <button onclick="window.location.href='genservpdf.php';">Download</button>
        <button onclick="window.location.href='addserv.php';">Add Service</button>
        <button onclick="window.location.href='delserv.php';">Remove Service</button>
        <button onclick="window.location.href='updateserv.php';">Update Service</button>
        </div>
    </div> 
</body>
</html>
