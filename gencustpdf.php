...
class PDF extends FPDF {
    function Header(){
        ...
        $this->Cell(0,10,'Customer List',0,1,'C');
        ...
        $this->Cell(30,10,'Age',1,0,'C',true);
        $this->Cell(30,10,'Gender',1,0,'C',true);
...
while($data=mysqli_fetch_array($query)){
        $pdf->Cell(30,10,$data['0'],1,0,'R');
        $pdf->Cell(30,10,$data['1'],1,0);
        $pdf->Cell(35,10,$data['2'],1,0);
        $pdf->Cell(30,10,$data['3'],1,0,'R');
        $pdf->Cell(30,10,$data['4'],1,0);
        $pdf->Cell(40,10,$data['5'],1,0);
        $pdf->Cell(30,10,$data['6'],1,0);
        $pdf->Cell(50,10,$data['7'],1,1);
}
