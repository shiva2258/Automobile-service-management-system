<?php
    ...
    $sql = "UPDATE delivery SET bill_no='$bno', del_address='$daddress', del_by='$dby', 
    del_date='$ddate' where cust_id='$cid' and auto_id='$aid';";
    // echo $sql;
...
<head>
    ...
    <title>Automobile Services - Update Delivery</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="updatedelivery.php" method="post">
            ...
            <button class="btn" onclick="window.location.href='updatedelivery.php';">UPDATE</button>
        </form>
    </div> 
</body>
</html>