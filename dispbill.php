...
<head>
    ...
    <title>Automobile Services - Display Bills</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $var = mysqli_query($con, "select * from bill order by bill_no,cust_id");
        ...
        <button onclick="window.location.href='genbillrep.php';">Generate Report</button>
        <button onclick="window.location.href='genbillpdf.php';">Download Complete Report</button>
        </div>
    </div> 
</body>
</html>